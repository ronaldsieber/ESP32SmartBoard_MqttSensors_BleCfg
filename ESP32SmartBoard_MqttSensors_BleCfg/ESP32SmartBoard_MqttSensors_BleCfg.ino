...
const uint32_t  DHT_SENSOR_SAMPLE_PERIOD            = 30000; //$$$$$$ 60000             // Sample Period for DHT-Sensor in [ms]
...
const uint32_t  MHZ19_SENSOR_SAMPLE_PERIOD          = 30000; //$$$$$$ 60000             // Sample Period for MH-Z19-Sensor in [ms]
